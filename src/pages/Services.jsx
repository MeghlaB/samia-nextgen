...
import Services from "../components/Hooks/Services";
    ...
    state: { details: service } 
              ...
              >
                <div className="!absolute mx-4 inset-0 !flex flex-col justify-center items-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                  <div className="!block w-full text-lg font-semibold text-primary rounded-sm text-gray-500 py-2  border-gray-200 hover:bg-gray-100">
                    <div className="flex gap-0.5 items-center justify-center text-green-700">
                      {" "}
                      <span className="">See Pricing</span>
                      <AiOutlineArrowRight />
                    </div>
                  </div>
                </div>
                <div className="opacity-100 group-hover:opacity-0 transition-opacity duration-300">
                  <div>
                    <img
                      src={service.image}
                      alt={service.title}
                      className="w-full object-cover h-60 max-xl:h-32 max-xl:w-32 mx-auto bg-white rounded-md mb-2"
                    />
                  </div>
