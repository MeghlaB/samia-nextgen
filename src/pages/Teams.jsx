...
const teamMembers = [
    {
        ...
        description: "Visionary leader with over 10 years of experience in the tech industry."
    },
    {
        name: "Jane Smith",
        role: "CTO",
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                {teamMembers.map((member, index) => (
                    <JackInTheBox key={index} >
                        <div className="text-center shadow-lg p-6 rounded-lg border border-gray-300 border-primary transform hover:scale-105 transition-transform duration-300 hover:shadow-[0_0_5px_theme(colors.primary.DEFAULT),0_0_20px_theme(colors.primary.DEFAULT)] hover:cursor-pointer">
                        <img src={member.image} alt={member.name} className="w-48 h-48 object-cover border mx-auto border-gray-300 rounded-full" />
                        <div className="p-4">
